  ...
  return (
    <>
      <Stack sx={{ position: "relative" }}>
        ...
        <Box sx={{ mt: "30px" }}>
          <SectionTitle sectionTitle={{ main: "الطلبات قيد التنفيذ" }} />
          {/* search and filter  */}
          <Box
            sx={{
              margin: "0 19px 41px",
        ...
        .fill("")
        .map((item) => (
          <Orders isNew={false} statusArray={statusArray} />
        ))} */}
        <Orders statusArray={statusArray.slice(0, 1)} />
        <Orders statusArray={statusArray.slice(0, 2)} />
        <Orders statusArray={statusArray.slice(0, 3)} />
        <Orders statusArray={statusArray.slice(0, 4)} />
      </Stack>
      <ModalComponent
        open={open}
